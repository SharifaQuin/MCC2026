...
// Recruiting V1 — the original thank-you page, preserved verbatim so it
// stays reachable exactly as it was if the Recruiting Experience toggle is
// switched back to Draft 1.
export default function ThankYouV1() {
  return (
